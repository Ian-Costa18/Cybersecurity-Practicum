...
{\small What exactly will you work on for your practicum project?}
...
{\small Why do you think this problem is important and has real-world relevance?}
...
{\small What do you expect to complete by the time you are done?}
...
% Feedback: The motivation requires a more compelling use case (perhaps the supply chain one in additional detail). Also, first state the problem that the multi-sinature solution is trying to address. What challenges do you anticipate? How will you demonstrate that the solution effectively solves the problem? What would evaluation look like? What are the specific tasks and deliverables? How would you evaluate the security, usability, and performance of the solution?  The draft lacks these key details. Please address these in your revised proposal. Please also look for multi-person multi-auth papers on Google scholar and you will find several which may be relevant.
