...
% Ian,
% Good work on PR3. Thank you for sharing the diff document, it made tracing your progress much easier. Thank you also for using IEEE-style in-text citations and a reference list. That was an excellent improvement from PR2.
% You also did a good job addressing the professor's PR1 feedback and the PR2 comments. The revised Problem Statement is much stronger because it focuses on the cybersecurity gap first, and the added citations make the motivation easier to follow.
% The implementation progress is strong as well.
% For PR4, Please also keep adding draft work/final report and artifacts to the appendix.
% Please review the rubric feedback and any inline or in-text comments for more details.
% Great progress overall, and I look forward to seeing how this develops in PR4, the final presentation, and the final report.
% Best,
% Emad

% Comments

% Complete Template - {Appendix
% If there are notes, sources, figures you want to reference please include that here.}

% The progress report should be a self-contained document that allows the reader to understand your project without needing to open external links or attachments.

% Attachments are acceptable for supplementary material, such as detailed designs, code snippets, diagrams, or additional documentation. However, they should complement the report, not replace it. The main PR should still contain a concise summary of all essential information, with the attachment providing additional detail if needed.
