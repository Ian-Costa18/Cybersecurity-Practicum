...
% ── 1. Problem Statement ────────────────────────────────────────────────────
% PR4 NOTE (Notes §3): Reframe to GENERAL -> CONCRETE bookend. Currently concrete-first
...
% PR4 NOTE (Notes §3): Same bookend — make sure generality reads as vision/framing, not an
...
% PR4 NOTE: The PR3 body below (MVP build-out) is DISABLED — it is the previous period.
...
% PR4 NOTE: The PR3 list below is DISABLED — items 1 (threat model) and 4 (outline) are
...
% PR4 NOTE (Notes §5): Per Ian, DO NOT carry the PR3 self-grading / MITRE-anchor question
...
% PR4 NOTE (Notes §1): The claims paragraph below describes the OLD claims in the OLD order
...
% PR4 NOTE (Notes §2): This section is an empty placeholder and the outline is now DUE (PR4).
...
% PR4 NOTE (Notes §4): Add for PR4 (the final-report appendix will mirror this):
