...
- GitHub Docs, "About pull request reviews" — https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/reviewing-changes-in-pull-requests/about-pull-request-reviews (accessed 2026-07-15) → `gh-about-pr-reviews`
...
> Required reviews require "a specific number of approving reviews from people with write or admin permissions in the repository before they can be merged." A pull request author cannot approve their own pull request — the approval must come from a different account.
— *About pull request reviews* (docs.github.com)
...
- `gh-about-protected-branches` — GitHub Docs, "About protected branches".
- `gh-about-pr-reviews` — GitHub Docs, "About pull request reviews".
- `gh-commit-signature-verification` — GitHub Docs, "About commit signature verification".
- `openwall-xz-backdoor` — A. Freund, oss-security disclosure of the xz/liblzma backdoor, CVE-2024-3094 (2024-03-29).
