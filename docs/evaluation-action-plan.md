...
7. **#122 (TOTP secrets encrypted at rest)** — same hardening family as the roll-up but not a #131 row (closes HOST-3's plaintext asymmetry, a ③ threat). In scope this cycle or future work?
