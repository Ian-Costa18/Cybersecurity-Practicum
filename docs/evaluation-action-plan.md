...
- Bucket ① today: **11** threats (CORE-1, CORE-2, PUB-1, PUB-2, VOTE-2, VOTE-3, HOST-2, IDENT-2, IDENT-5, DOS-1, IDENT-1) — tests verified passing. DOS-1 headline ① from its two demonstrated primary legs (storage #126 + flooding #32); its *connection-starvation* leg (d) stays operator-③. HOST-3 uniformly ② (#122). IDENT-2 detection leg ① (#128), prevention leg ③. IDENT-5 ① (#123). IDENT-1 detection leg ② → ① (#125). *(00-overview.md reconciled for IDENT-5 + DOS-1 by #147; **IDENT-1's ②→① overview flip still deferred to the cleanup pass** — its own threat file already says ①.)*
- **All 8 #131 checklist rows are ticked** (#121, #124, #126, #127, #128, #123, #32, #125). Remaining batch work: **#135** (VOTE-1 step-up re-auth + `severity_residual` critical→high; not a #131 row) — *in flight*; then the cleanup pass + final PR. #129/IDENT-4 stays descoped.
