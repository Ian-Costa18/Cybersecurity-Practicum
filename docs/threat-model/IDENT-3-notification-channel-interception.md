...
default (high), rated deliberately together with [IDENT-2](IDENT-2-enrollment-link-interception.md),
...
interception *is* IDENT-2's outcome (a durable quorum seat — one seat of m, hence high, not
