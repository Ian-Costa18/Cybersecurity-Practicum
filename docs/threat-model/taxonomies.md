...
| **TA0002 Execution** | T1059.006 Python (in-process code reaches the PyPI token, bypassing quorum); **T1204.002 User Execution: Malicious File** (an approver runs the untrusted review artifact on their own endpoint — [VOTE-5](VOTE-5-malicious-review-artifact-on-approver-endpoint.md)); T1203; T1053.003 cron | T1047 WMI, T1610 containers, T1648 serverless — not central to single-host Python |
