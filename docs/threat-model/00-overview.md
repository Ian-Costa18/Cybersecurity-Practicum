...
The configuration steps required to achieve the security posture described above — the
concrete work behind every ③ operator-enforced threat — live in their own document:
