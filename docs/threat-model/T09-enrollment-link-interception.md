...
**ATT&CK mapping.** T1586.002 — *Compromise Accounts: Email Accounts*: the attacker takes
over a victim's email account and harvests what lands in it — the realistic interception
path (TLS makes on-wire capture the rare case). The link's *delivery channel* is
[T16](T16-notification-channel-interception.md)'s surface (T1114); what captured
authentication material is worth afterward is [T8](T08-captured-credential-replay.md)'s.
